...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post equipment_index_url, params: { equipment: { cantidad: @equipment.cantidad, equipo: @equipment.equipo, potencia: @equipment.potencia, tiempo: @equipment.tiempo } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { cantidad: @equipment.cantidad, equipo: @equipment.equipo, potencia: @equipment.potencia, tiempo: @equipment.tiempo } }
