...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post components_url, params: { component: { cantidad: @component.cantidad, equipo: @component.equipo, potencia: @component.potencia, tiempo: @component.tiempo } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { cantidad: @component.cantidad, equipo: @component.equipo, potencia: @component.potencia, tiempo: @component.tiempo } }
